---
title: Draft agenda (run of show)
status: draft
owner: Katy
created: 2026-09-21
...
|---|---|---|---|
| 18:30 | Doors, registration, name tags, drinks | Registration team | Music low; a one-page timeline on each seat or a screen loop of the summer-2026 timeline (D01) |
| 19:00 | Welcome: why we are here, who is in the room, house rules for questions | Host (Dave or Katy) | 5 min. Ask for a show of hands by segment; it sets the tone that this is for non-experts |
| 19:05 | **Talk 1 — What actually happened** | Stan | 20–25 min. The incident as a story, then the nine escapes and the detection findings. Interruptible: host collects questions on cards or a shared doc |
...
replace 19:55–20:25 with 15 min table discussion on one prompt ("What would this incident
change about how your organisation uses AI agents?") followed by 15 min plenary.
