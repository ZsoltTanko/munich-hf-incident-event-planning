...
| File | Purpose |
|---|---|
| `application-draft.md` | Every field of the Airtable form (S07) with a draft answer. Copy from here into the form. This Markdown file is the only version (D-14). |
