...
| `bluedot-application-draft-v0.1.docx` / `.pdf` | Proof of concept: the application draft laid out as a submittable document, placeholders highlighted. **Predates the 2026-09-25 meeting (S15); regenerate before sharing.** Generated by `scripts/build-application-docx.js` on 2026-09-21; regenerate after the draft changes rather than editing the .docx by hand. |
