...
| **LinkedIn ads** | Targeted at Munich AI/engineering leadership titles | "cost is unclear" (S01); budget 0–600 EUR in `grant/budget.md` | TBC | decide after grant |
| **EA Munich** | Patrick Grubin's "fairly large EA circle" (S01) | Free | Zsolt/Ada to ask | not asked |
| **ACX Munich** | Community post | Free | TBC | not asked |
| **PauseAI Munich** | Post; ask for audience-finding advice (S01) | Free | TBC | not asked |
| **TUM student groups** | Mailing lists, AI clubs, posters | Free | TBC | not asked |
...
- Students: lead with the research angle and the route into the field.
- EA/ACX/PauseAI: lead with "bring a colleague who hasn't heard the details".
- Everyone: one date, one link, speaker names with one-line credentials.

Copy drafts live in `copy/`.
